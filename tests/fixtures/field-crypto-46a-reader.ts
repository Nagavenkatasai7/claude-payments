// FROZEN — NEVER EDIT. Program-Fix 46B rollback proof.
// Byte-for-byte copy of src/lib/field-crypto.ts at 6dbfb1e (Program-Fix 46A,
// the reader-only build). tests/field-crypto-rollback-46a.test.ts opens every
